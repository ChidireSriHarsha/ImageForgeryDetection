...
title.config(height=3, width=160)       
title.place(x=100,y=5)
title.pack()

font1 = ('times', 13, 'bold')
uploadButton = Button(main, text="Upload MICC Dataset")
uploadButton.place(x=10,y=100)
uploadButton.config(font=font1)


processButton = Button(main, text="Acquire Images")
processButton.place(x=10,y=150)
processButton.config(font=font1) 


svmButton = Button( main,text="Run Existing SVM Algorithm")
svmButton.place(x=10,y=210)
svmButton.config(font=font1) 

orbButton = Button(main, text="Run Propose ORB Algorithm", command=runORB)
orbButton.place(x=10,y=270)
orbButton.config(font=font1)

exitButton = Button(main, text="Exit", command=close)
exitButton.place(x=10,y=320)
exitButton.config(font=font1)

font1 = ('times', 12, 'bold')
text=Text(main,height=35,width=140)
